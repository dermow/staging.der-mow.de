...
### terraform apply
Mit "apply" übernehmen wir die Änderungen, die wir vorher mit Plan gepeichert haben:
```bash
terraform apply "/tmp/my-plan-file"
```
```
...
Fertig! Die Instanz wurde erstellt und sollte nun in unserer AWS-Umgebung laufen :)
